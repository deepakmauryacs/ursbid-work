        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Seller List</h4>
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        ...
                        <!-- <div class="action-btn">
                            <a href="{{ url('admin/Seller/add') }}" class="btn btn-sm btn-primary btn-add">
                                <i class="la la-plus"></i> Add New Seller</a>
                        </div> -->
                    </div>
                </div>
                                ...
                                <table class="table mb-0">
                                    <thead>
                                        <tr class="userDatatable-header">
                                            ...
                                            <th>
                                                <span class="projectDatatable-title">Join user </span>
                                            </th>
                                            <th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-inline-block">
                                                    ...
                                                    <a href="{{ url('admin/joinmember/'.$blog->ref_code) }}">
                                                        <span class="media-badge color-white bg-primary">View
                                                            member</span>
                                                    </a>
                                            ...
                                            <!-- <td>
                                                <div class="userDatatable-content">
                                                {!! QrCode::size(50)->generate(url('/qrdetail/' . $blog->hash_id)) !!}
                                                </div>
                                            </td> -->
                                            ...
                                            <!-- <td>
                                                ...
                                                <div class="d-inline-block">
                                                    @if($blog->status==1)
                                                    <a href="{{ url('admin/seller/active/'.$blog->id) }}">
                                                        <span class="media-badge color-white bg-primary">Active</span>
                                                    </a>
                                                    @else
                                                    <a href="{{ url('admin/seller/deactive/'.$blog->id) }}">
                                                        <span class="media-badge color-white bg-danger">De-active</span>
                                                    </a>
                                                    @endif
                                                    ...
                                                    <div class="dropdown  dropdown-click ">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/Seller/edit/'.$blog->id) }}">Edit</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/Seller/delete/'.$blog->id) }}"
