        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Client List</h4>
                            ...
                            <div class="col-md-2 no-padding-left">
                                <div class="form-group">
                                    <select class="form-control select2" name="order_by">
                                        <option value="one" >Most Users</option>
                                        <option value="two" >Most Raised </option>
                                                    ...
                                                    <div class="dropdown  dropdown-click ">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/Buyer/edit/'.$blog->id) }}">Edit</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/Buyer/delete/'.$blog->id) }}"
