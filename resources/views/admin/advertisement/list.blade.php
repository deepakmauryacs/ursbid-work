        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Advertisement List</h4>
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        ...
                        <div class="action-btn">
                            <a href="{{ url('admin/advertisement/add') }}" class="btn btn-sm btn-primary btn-add">
                                <i class="la la-plus"></i> Add New Advertisement</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <a href="{{ url('admin/advertisement/active/'.$blog->advertisement_id) }}">
                                                        <span class="media-badge color-white bg-primary">Active</span>
                                                    </a>
                                                    @else
                                                    <a href="{{ url('admin/advertisement/deactive/'.$blog->advertisement_id) }}">
                                                    ...
                                                    <div class="dropdown  dropdown-click ">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/advertisement/edit/'.$blog->advertisement_id) }}">Edit</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/advertisement/delete/'.$blog->advertisement_id) }}"
