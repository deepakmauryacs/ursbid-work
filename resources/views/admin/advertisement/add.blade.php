        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Add Advertisement</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-default card-md mb-4">
                        <div class="card-header">
                            <h6>Add Advertisement </h6>
                        </div>
                        <div class="card-body py-md-25">
                            <form method="post" action="{{ route('admin.advertisement.create') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="cat_id" id=""
                                            ...
                                            @php
                                            $category = DB::select("SELECT * FROM sub WHERE status = 1");
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file"
                                                ...
                                                name="image" placeholder="Date" required value="{{ old('image') }}">
                                        </div>
                                        @if ($errors->has('image'))
