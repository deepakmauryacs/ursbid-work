            ...
            <div class="col-md-12">
                ...
                <div class="breadcrumb-main">
                    ...
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        ...
                        <div class="action-btn">
                            <a href="{{ url('admin/blog/add') }}" class="btn btn-sm btn-primary btn-add">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-inline-block">
                                                    @if($blog->status==1)
                                                    <a href="{{ url('admin/blog/active/'.$blog->id) }}">
                                                        <span class="media-badge color-white bg-primary">Active</span>
                                                    </a>
                                                    @else
                                                    <a href="{{ url('admin/blog/deactive/'.$blog->id) }}">
                                                    ...
                                                    <div class="dropdown  dropdown-click ">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/blog/edit/'.$blog->id) }}">Edit</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/blog/delete/'.$blog->id) }}"
