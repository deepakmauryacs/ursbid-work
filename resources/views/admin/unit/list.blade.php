        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">unit List</h4>
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        ...
                        <div class="action-btn">
                            <a href="{{ url('admin/unit/add') }}" class="btn btn-sm btn-primary btn-add">
                                <i class="la la-plus"></i> Add New unit</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-inline-block">
                                                    @if($blog->unit_status==1)
                                                    <a href="{{ url('admin/unit/active/'.$blog->unit_id) }}">
                                                        <span class="media-badge color-white bg-primary">Active</span>
                                                    </a>
                                                    @else
                                                    <a href="{{ url('admin/unit/deactive/'.$blog->unit_id) }}">
                                                    ...
                                                    <div class="dropdown  dropdown-click ">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/unit/edit/'.$blog->unit_id) }}">Edit</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/unit/delete/'.$blog->unit_id) }}"
