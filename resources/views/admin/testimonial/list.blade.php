        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Testimonial List</h4>
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        ...
                        <div class="action-btn">
                            <a href="{{ url('admin/testimonial/add') }}" class="btn btn-sm btn-primary btn-add">
                                <i class="la la-plus"></i> Add New Testimonial</a>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table mb-0">
                                    <thead>
                                        <tr class="userDatatable-header">
                                            ...
                                            <th>
                                                <span class="projectDatatable-title">Position</span>
                                            </th>
                                            <th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-inline-block">
                                                    @if($blog->status==1)
                                                    <a href="{{ url('admin/testimonial/active/'.$blog->id) }}">
                                                        <span class="media-badge color-white bg-primary">Active</span>
                                                    </a>
                                                    @else
                                                    <a href="{{ url('admin/testimonial/deactive/'.$blog->id) }}">
                                                    ...
                                                    <div class="dropdown  dropdown-click ">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/testimonial/edit/'.$blog->id) }}">Edit</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/testimonial/delete/'.$blog->id) }}"
