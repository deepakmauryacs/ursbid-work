                ...
                <div class="col-lg-12">
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body py-md-25">
                            <form method="post" action="{{ url('admin/testimonial/update/'.$blog->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Name" name="name" value="{{ $blog->title }}">
                                        </div>
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control ih-medium ip-light radius-xs b-light px-15" id="a8"
                                                placeholder="position" name="position" value="{{ $blog->position }}">
                                        </div>
