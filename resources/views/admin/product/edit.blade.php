                ...
                <div class="col-lg-12">
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body py-md-25">
                            <form method="post" action="{{ url('admin/product/update/'.$blog->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" class="form-control ih-medium ip-light radius-xs b-light px-15"
                                        id="a9" name="insert_by" placeholder="" value="{{ $blog->insert_by }}">

                                    <input type="hidden" class="form-control ih-medium ip-light radius-xs b-light px-15"
                                        id="a9" name="user_type" placeholder="Date" value="{{ $blog->user_type }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                class="form-control ih-medium ip-light radius-xs b-light px-15" id="a8"
                                                placeholder="Order Number" name="order_by"
                                                value="{{ $blog->order_by }}">
                                        </div>
