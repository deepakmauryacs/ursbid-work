                        ...
                        <div class="card-body py-md-25">
                            <form method="post" action="{{ route('admin.product.create') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="cat_id" id="cat_id"
                                                class="form-control cat_id ih-medium ip-light radius-xs b-light px-15">
                                    ...
                                    <input type="hidden" class="form-control ih-medium ip-light radius-xs b-light px-15"
                                        id="a9" name="update_by" placeholder="Date" value="Admin">

                                    <input type="hidden" class="form-control ih-medium ip-light radius-xs b-light px-15"
                                        id="a9" name="insert_by" placeholder="Date" value="Admin">

                                    <input type="hidden" class="form-control ih-medium ip-light radius-xs b-light px-15"
                                        id="a9" name="user_type" placeholder="Date" value="Admin">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                class="form-control ih-medium ip-light radius-xs b-light px-15" id="a8"
                                                placeholder="Order Number" name="order_by" value="{{ old('order_by') }}">
                                        </div>
