            ...
            <div class="col-md-12">
                ...
                <div class="breadcrumb-main">
                    ...
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        ...
                        <div class="action-btn">
                            <a href="{{ url('admin/product/add') }}" class="btn btn-sm btn-primary btn-add">
                                ...
                                <table class="table mb-0">
                                    <thead>
                                        <tr class="userDatatable-header">
                                            ...
                                            <th>
                                                <span class="projectDatatable-title">Order No</span>
                                            </th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="userDatatable-content">
                                                    <img src="{{ url('public/uploads/'.$blog->img) }}"
                                                        style='width:100px; width:80px;' alt="">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="userDatatable-content">
                                            ...
                                            <td>
                                                ...
                                                <div class="d-inline-block">
                                                    @if($blog->product_status==1)
                                                    <a href="{{ url('admin/product/active/'.$blog->product_id) }}">
                                                        <span class="media-badge color-white bg-primary">Active</span>
                                                    </a>
                                                    @else
                                                    <a href="{{ url('admin/product/deactive/'.$blog->product_id) }}">
                                                    ...
                                                    <div class="dropdown  dropdown-click ">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/product/edit/'.$blog->product_id) }}">Edit</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/product/delete/'.$blog->product_id) }}"
