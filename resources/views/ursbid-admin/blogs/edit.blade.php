                ...
                <div class="card-body">
                    <form id="blogForm" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="post_date" id="post_date" class="form-control" value="{{ $blog->post_date }}" placeholder="dd-mm-yyyy" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="order_by" class="form-control" value="{{ $blog->order_by }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4">
