        ...
        <div class="col-12">
            <div class="card mb-4 shadow-sm">
                <div class="card-header border-0 bg-white d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <button class="btn btn-outline-secondary btn-sm d-lg-none" type="button" data-bs-toggle="collapse" data-bs-target="#activeQuotationFilters" aria-expanded="true" aria-controls="activeQuotationFilters">
                        Toggle Filters
                    </button>
                </div>

                <div class="collapse show" id="activeQuotationFilters">
                    <div class="card-body">
