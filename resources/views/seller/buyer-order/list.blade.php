        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Bidding Recieved </h4>
                    ...
                    <div class="card-header bg-white border-0 pb-0">
                        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between">
                            <div class="d-flex align-items-center mb-2 mb-md-0">
                                ...
                                <h5 class="mb-0">Refine Bidding Results</h5>
                            </div>
                            <p class="text-muted small mb-0">Use the filters below to quickly narrow down the bids you see.</p>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-sm-12">
                                    <div class="padd">
                                        ...
                                        if($total < 1){ echo "<div class='text-danger'>Sorry, No data Found!</div>" ;
                                            ...
                                            @if(isset($datas['keyword']) && $data->count() > 0)
