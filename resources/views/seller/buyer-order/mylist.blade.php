                    ...
                    <div class="card-header bg-white border-0 pb-0">
                        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between">
                            <div class="d-flex align-items-center mb-2 mb-md-0">
                                ...
                                <h5 class="mb-0">Refine My Bidding</h5>
                            </div>
                            <p class="text-muted small mb-0">Adjust the filters to find bids that match your criteria.</p>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table align-middle text-nowrap table-hover table-centered mb-0">
                                    ...
                                    <head>
                                        <tr>
                                            ...
                                            <th>
                                                <span class="projectDatatable-title ">Payment_Status</span>
                                            </th>
                                        </tr>
                                    </head>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="userDatatable-content text-success">
                                                    {{ $all->bidding_price_payment_status }}
                                                </div>
                                            </td>
