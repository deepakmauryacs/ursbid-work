@php
$uid = session('seller')->id;

$acc = DB::table('seller')->where('id' , $uid)->first();
    ...
    <header class="header-top">
        <nav class="navbar navbar-light">
            <div class="navbar-left">
                ...
                <a class="navbar-brand" href="{{ url('/') }}"><img class="dark"
                        src="{{url('assets/front/img/logo.png')}}" style='width:100px; height:70px; object-fit:contain;'
                        alt="svg"><img class="light" src="{{url('assets/front/img/logo.png')}}"
                        style='width:100px; height:70px; object-fit:contain;' alt="img"></a>
                    ...
                    <li class="nav-support">
                        <div class="dropdown-custom">
                            <a href="{{ url('seller/logout') }}"
                                class="nav-item-toggle btn-sm btn btn-primary text-white">
                                Logout</a>
                ...
                <div class="sidebar__menu-group">
                    <ul class="sidebar_nav">
                        ...
                        <!-- <li class="has-child">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ url('seller/blog/list') }}" class="">
                        ...
                        <!-- <li class="has-child">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ url('seller/category/list') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                        ...
                        <!-- <li class="has-child">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ url('seller/sub/list') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                        ...
                        <!-- <li class="has-child">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ url('seller/product/list') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                        ...
                        <li class="has-child">
                            ...
                            <ul>
                                ...
                                @endphp
                                <li>
                                    <a href="{{ url('seller/enquiry/list') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                                        <span class="menu-text">Active Enquiry List</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('seller/enquiry/deactivelist') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                                        <span class="menu-text">Closed Enquiry List</span>
                                    </a>
                                </li>
                                @php
                                ...
                                @endphp
                                @php
                                if (in_array(3, $acc_type_array)  || in_array(4, $acc_type_array) ) {

                                @endphp
                                <li>
                                    <a href="{{ url('seller/enquiry/myenclist') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                                        <span class="menu-text">My Enquiry List</span>
                                    </a>
                                </li>
                                @php
                        ...
                        <li class="has-child">
                            <a href="#" class="">
                                <span data-feather="layout" class="nav-icon"></span>
                                <span class="menu-text">Bidding List </span>
                                <span class="toggle-icon"></span>
                            </a>
                            <ul>
                            @php
                                ...
                                @endphp
                                <li>
                                    <a href="{{ url('buyer-order') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                                        <span class="menu-text">Bidding Recieved </span>
                                    </a>
                                </li>
                                @php
                                ...
                                @endphp
                                <li>
                                    <a href="{{ url('buyer-order/mylist') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                                        <span class="menu-text">My Bidding </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('buyer-order/acc-list') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                                        <span class="menu-text">Accepted Bidding </span>
                                    </a>
                                </li>
                                @php
                        ...
                        <li class="has-child">
                            ...
                            @php
                                ...
                                @endphp
                                <li>
                                    <a href="{{ url('seller/accounting/biddrecive') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                                        <span class="menu-text">Bidding Recieved</span>
                                    </a>
                                </li>
                                ...
                                @endphp
                                <li>
                                    <a href="{{ url('seller/accounting/list') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                                        <span class="menu-text">Total Bidding</span>
                                    </a>
                                </li>
                               
                                
                                <li>
                                    <a href="{{ url('seller/accounting/accbid') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                                        <span class="menu-text">Accepted Bidding</span>
                                    </a>
                                </li>
                        ...
                        <li class="has-child">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ url('seller/accounting/totalshare') }}" class="">
                                        <span data-feather="message-square" class="nav-icon"></span>
                        ...
                        <li class="">
                            <a href="{{ url('delete-account') }}" class="">
                                <span data-feather="home" class="nav-icon"></span>
                        ...
                        <li class="">
                            @php
                            $hash_id = session('seller') ? session('seller')->hash_id : null;
                            @endphp

                            <a href="{{ $hash_id ? url('update-account/'.$hash_id) : '#' }}" class="">
                                <span data-feather="home" class="nav-icon"></span>
                                <span class="menu-text">Update Account</span>
                                <span class="toggle-icon"></span>
                            </a>
