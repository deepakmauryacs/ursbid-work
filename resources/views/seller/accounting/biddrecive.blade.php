...
@section('title', 'Bidding Recieved List')
<!--  -->
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Bidding Recieved list </h4>
                    ...
                    <div class="card-header bg-white border-0 pb-0">
                        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between">
                            <div class="d-flex align-items-center mb-2 mb-md-0">
                                ...
                                <h5 class="mb-0">Filter Bidding Received</h5>
                            </div>
                            <p class="text-muted small mb-0">Keep filters visible and apart from the table for better clarity.</p>
                        </div>
                    </div>
                    <div class="card-body">
