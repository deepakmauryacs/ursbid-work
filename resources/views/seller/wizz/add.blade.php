        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Add wizz</h4>
                        ...
                        <div class="col-xl-8">
                            ...
                            <h6>Add wizz     </h6>
                                        ...
                                        <div class="card-body py-md-25">
                                            <form method="post" action="{{ route('admin.wizz.create') }}"
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                id="a8" placeholder="Title" name="title"
                                                                value="{{ old('title') }}">
                                                        </div>
                                                        @if ($errors->has('title'))
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <button type="submit" class="px-4 btn-sm btn-primary">Submit & Next
                                                        -></button>
                                                </div>
