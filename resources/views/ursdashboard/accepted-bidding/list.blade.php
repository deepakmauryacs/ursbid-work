...
@php
    ...
    $acceptedBiddingUrl = route('acc-list');
@endphp
        ...
        <div class="row">
            <div class="col-lg-12 mb-30">
                <div class="card mb-4 shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center border-bottom">
                        ...
                        <button class="btn btn-outline-secondary btn-sm d-lg-none" type="button" data-bs-toggle="collapse"
                            data-bs-target="#acceptedBidsFilters" aria-expanded="true" aria-controls="acceptedBidsFilters">
                            Toggle Filters
                        </button>
                    </div>

                    <div class="collapse show" id="acceptedBidsFilters">
                        <div class="card-body">
                            @php
                                $filters = $filters ?? [];
                                $categories = $categories ?? [];
                            @endphp
                            <form id="acceptedBidsFiltersForm" class="row g-3 align-items-end" method="get" action="{{ $acceptedBiddingUrl }}">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="r_page" class="form-select" id="acceptedBidsRecords">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3">
                                    ...
                                    <div class="d-flex flex-column flex-sm-row flex-lg-column flex-xl-row gap-2">
                                        ...
                                        <button type="button" id="resetAcceptedBidsFilters" class="btn btn-outline-secondary w-100 flex-fill">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <div id="acceptedBidsTable">
                            @include('ursdashboard.accepted-bidding.partials.table', [
                                'records' => $records,
                                'filters' => $filters,
                            ])
                        </div>
...
<script type="text/javascript">
    (function ($) {
        const $form = $('#acceptedBidsFiltersForm');
        const $recordsPerPage = $('#acceptedBidsRecords');
        const $resetButton = $('#resetAcceptedBidsFilters');
